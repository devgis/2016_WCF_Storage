...
namespace EMSWCF
{
    public class DataBase:IDisposable
    {
        ...
        private void Open()
        {
            ...
            {
                //con = new SqlConnection("Data Source=192.168.1.100;DataBase=db_EMS;User ID=sa;PWD=123456");//创建数据库连接对象
                con = new SqlConnection(System.Configuration.ConfigurationManager.AppSettings["db"].ToString());
            }
