...
namespace EMS.SaleStock
{
    public partial class frmResellStock : Form
    {
        ...
        private void frmResellStock_Load(object sender, EventArgs e)
        {
            ...
            ds = PublicDim.client.GetAllBill("tb_resell_main");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //执行添加
            PublicDim.client.AddTableMainWarehouse(billinfo, "tb_resell_main");
            ...
            for (int i = 0; i < dgvStockList.RowCount - 1; i++)
            {
                ...
                //执行多行录入数据（添加到明细表中）
                PublicDim.client.AddTableDetailedWarehouse(billinfo, "tb_resell_detailed");
                //更改库存数量和加权平均价格
                DataSet ds = null;
                ...
                int d = PublicDim.client.UpdateStock_QtyAndAveragerprice(stockinfo);
