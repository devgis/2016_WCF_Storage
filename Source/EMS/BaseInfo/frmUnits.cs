...
namespace EMS.BaseInfo
{
    ...
    {
        DBSR.cUnitsInfo unitsInfo = new DBSR.cUnitsInfo();
        ...
        private void frmUnits_Load(object sender, EventArgs e)
        {
            ...
            this.cancelEnabled();
            dgvUnitsList.DataSource = PublicDim.client.GetAllUnits("tb_units").Tables[0].DefaultView;
        ...
        private void tlBtnAdd_Click(object sender, EventArgs e)
        {
            ...
            ds = PublicDim.client.GetAllUnits("tb_units");
        ...
        private void tlBtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (G_Int_addOrUpdate == 0)
            {
                try
                {
                    ...
                    //执行添加
                    int id = PublicDim.client.AddUnits(unitsInfo);
            ...
            else
            {
                ...
                unitsInfo.Accounts = txtAccounts.Text;
                //执行修改
                int id = PublicDim.client.UpdateUnits(unitsInfo);
        ...
        private void tlBtnFind_Click(object sender, EventArgs e)
        {
            ...
            if (tlCmbUnitsType.Text == "单位编号")  //按单位编号查询
            {
                ...
                ds = PublicDim.client.FindUnitsByUnitCode(unitsInfo, "tbUnits");
                dgvUnitsList.DataSource = ds.Tables[0].DefaultView;
            }
            else　　　　　　　　　　　　　　　　　//按单位名称查询
            {
                unitsInfo.FullName = tlTxtFindUnits.Text;
                ds = PublicDim.client.FindUnitsByFullName(unitsInfo, "tbUnits");
                dgvUnitsList.DataSource = ds.Tables[0].DefaultView;
            }
            this.SetdgvUnitsListHeadText(); 
        }
        ...
        private void tlBtnDelete_Click(object sender, EventArgs e)
        {
            ...
            unitsInfo.UnitCode = txtUnitCode.Text;
            //执行删除
            int id = PublicDim.client.DeleteUnits(unitsInfo);
