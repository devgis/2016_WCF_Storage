...
namespace EMS.BaseInfo
{
    ...
    {
        DBSR.cEmployeeInfo employeeinfo = new DBSR.cEmployeeInfo();
        ...
        private void frmEmployee_Load(object sender, EventArgs e)
        {
            ...
            this.cancelEnabled();
            dgvEmployeeList.DataSource = PublicDim.client.GetAllEmployee("tb_employee").Tables[0].DefaultView;
        ...
        private void tlBtnFind_Click(object sender, EventArgs e)
        {
            ...
            if (tlCmbEmployeeType.Text == "所在部门")  //按单位编号查询
            {
                ...
                ds = PublicDim.client.FindEmployeeByDept(employeeinfo, "tb_employee");
                dgvEmployeeList.DataSource = ds.Tables[0].DefaultView;
            }
            else　　　　　　　　　　　　　　　　　//按单位名称查询
            {
                employeeinfo.FullName = tlTxtFindEmployee.Text;
                ds = PublicDim.client.FindEmployeeByFullName(employeeinfo, "tb_Employee");
                dgvEmployeeList.DataSource = ds.Tables[0].DefaultView;
            }
            this.SetdgvEmployeeListHeadText();
        ...
        private void tlBtnAdd_Click(object sender, EventArgs e)
        {
            ...
            ds = PublicDim.client.GetAllEmployee("tb_employee");
        ...
        private void tlBtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (G_Int_addOrUpdate == 0)
            {
                try
                {
                    ...
                    //执行添加
                    int id = PublicDim.client.AddEmployee(employeeinfo);
            ...
            else
            {
                ...
                //执行修改
                int id = PublicDim.client.UpdateEmployee(employeeinfo);
        ...
        private void tlBtnDelete_Click(object sender, EventArgs e)
        {
            ...
            employeeinfo.EmployeeCode = txtEmpployCode.Text;
            //执行删除
            int id = PublicDim.client.DeleteEmployee(employeeinfo);
